function Navbar() {
    ...
    return (
        <nav className="navbar bg-white bg-dark">
            <div className="container pe-0">
                <span className="navbar-brand mb-0 h1 fw-bold">Explore Alephium</span>
                <a className="navbar-brand mb-0 text-decoration-none text-dark" href="https://github.com/WilhelmKallstrom/alph-top" target="_blank">
